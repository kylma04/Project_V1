...
Gem::Specification.new do |s|
  ...
  s.authors = ["Samuel Williams".freeze, "Math Ieu".freeze, "Bruno Sutic".freeze, "Alex Matchneer".freeze, "Benoit Daloze".freeze, "Delton Ding".freeze]
